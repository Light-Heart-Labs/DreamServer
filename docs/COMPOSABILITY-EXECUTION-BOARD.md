...
- [`get-dream-server.sh`](../dream-server/get-dream-server.sh)
...
- [`scripts/mode-switch.sh`](../dream-server/scripts/mode-switch.sh)
Acceptance:
...
- [`dashboard-api/main.py`](../dream-server/extensions/services/dashboard-api/main.py)
Acceptance:
...
- `.env.schema.json` (new)
- [`install.sh`](../install.sh)
- [`scripts/migrate-config.sh`](../dream-server/scripts/migrate-config.sh)
...
Effort: 3-4 days  
Files:
- [`dashboard/src/App.jsx`](../dream-server/extensions/services/dashboard/src/App.jsx)
- [`dashboard/src/components/Sidebar.jsx`](../dream-server/extensions/services/dashboard/src/components/Sidebar.jsx)
...
Effort: 2-3 days  
Files:
- [`dashboard/src/pages/Dashboard.jsx`](../dream-server/extensions/services/dashboard/src/pages/Dashboard.jsx)
- [`dashboard-api/main.py`](../dream-server/extensions/services/dashboard-api/main.py)
Acceptance:
...
- [`tests/test-phase-c-p1.sh`](../dream-server/tests/test-phase-c-p1.sh)
Acceptance:
...
- `manifest.json` (new)
- [`dashboard-api/main.py`](../dream-server/extensions/services/dashboard-api/main.py)
- [`dream-update.sh`](../dream-server/dream-update.sh)
Acceptance:
