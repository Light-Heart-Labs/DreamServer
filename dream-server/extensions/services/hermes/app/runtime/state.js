...
function normalizeState(state) {
  ...
  normalized.settings.providerMode = "local";
  normalized.chats = normalized.chats.map((chat) => ({ ...chat, provider: "local" }));
  ...
  normalized.settings.dreamPetEnabled = normalized.settings.dreamPetEnabled !== false;
