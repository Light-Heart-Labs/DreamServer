...
if ! $DRY_RUN && ! $FORCE; then
    if RESUME_PHASE=$(checkpoint_should_resume); then
...
[[ $START_PHASE -le 6 ]] && { INSTALL_PHASE="06-directories";  source "$SCRIPT_DIR/installers/phases/06-directories.sh"; checkpoint_save 6; }
