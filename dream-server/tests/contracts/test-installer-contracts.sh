...
for s in scripts/build-capability-profile.sh scripts/build-service-registry.py scripts/classify-hardware.sh scripts/load-backend-contract.sh scripts/resolve-compose-stack.sh scripts/preflight-engine.sh scripts/dream-doctor.sh scripts/simulate-installers.sh scripts/validate-manifests.sh; do
